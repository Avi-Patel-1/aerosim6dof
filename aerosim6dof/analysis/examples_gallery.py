...
CURATED_SCENARIOS: dict[str, dict[str, Any]] = {
    ...
    "missile_intercept_demo": {
        ...
        "primary_metrics": ["target_distance_m", "miss_distance_m", "missile_speed_mps", "seeker_valid", "missile_fuze_armed"],
    ...
    "missile_head_on_showcase": {
        "title": "Missile Head-On Showcase",
        "category": "Engagement",
        "difficulty": "Advanced",
        "description": "Short head-on intercept that makes seeker acquisition, motor spool-up, high closing speed, and fuze timing easy to see.",
        "tags": ["missile", "head-on", "seeker", "fuze", "showcase"],
        "primary_metrics": ["missile_seeker_range_m", "missile_closing_speed_mps", "missile_speed_mps", "missile_motor_spool_fraction", "missile_fuzed"],
        "expected_outputs": DEFAULT_EXPECTED_OUTPUTS + ["targets.csv", "interceptors.csv", "engagement_report.html"],
        "suggested_next_edit": "Clone it and widen or narrow field_of_view_deg to watch seeker validity drive the terminal shot.",
    },
    "missile_crossing_showcase": {
        "title": "Missile Crossing Showcase",
        "category": "Engagement",
        "difficulty": "Advanced",
        "description": "Crossing-target engagement for inspecting lateral acceleration, actuator saturation, seeker aspect angle, and miss-distance sensitivity.",
        "tags": ["missile", "crossing", "actuator", "guidance", "showcase"],
        "primary_metrics": ["missile_seeker_aspect_deg", "missile_lateral_accel_mps2", "missile_control_saturated", "interceptor_range_m", "missile_fuzed"],
        "expected_outputs": DEFAULT_EXPECTED_OUTPUTS + ["targets.csv", "interceptors.csv", "engagement_report.html"],
        "suggested_next_edit": "Clone it and reduce max_accel_mps2 or navigation_constant to see the miss distance open up.",
    },
    "missile_tail_chase_showcase": {
        "title": "Missile Tail-Chase Showcase",
        "category": "Engagement",
        "difficulty": "Advanced",
        "description": "Longer tail-chase engagement that exposes motor burn-down, speed build, time-to-go, and terminal fuze behavior.",
        "tags": ["missile", "tail-chase", "motor", "burn-down", "showcase"],
        "primary_metrics": ["missile_mass_kg", "missile_motor_thrust_n", "missile_speed_mps", "interceptor_time_to_go_s", "missile_fuze_closest_range_m"],
        "expected_outputs": DEFAULT_EXPECTED_OUTPUTS + ["targets.csv", "interceptors.csv", "engagement_report.html"],
        "suggested_next_edit": "Clone it and shorten burn_time_s to see how motor energy changes closest approach.",
    },
    "actuator_saturation": {
