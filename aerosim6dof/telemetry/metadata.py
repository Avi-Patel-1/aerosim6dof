...
KNOWN_CHANNELS: dict[str, TelemetryChannelMetadata] = {
    ...
    "missile_mode": _m("missile_mode", "Missile Dynamics Mode", "", "Boolean flag indicating the active interceptor is using the missile dynamics model.", "Missile", "history", "derived", valid_range=_r(0.0, 1.0), derived=True),
    "missile_speed_mps": _m("missile_speed_mps", "Missile Speed", "m/s", "Interceptor missile inertial speed from the missile dynamics model.", "Missile", "history", "derived", valid_range=_r(0.0, None), derived=True),
    "missile_mass_kg": _m("missile_mass_kg", "Missile Mass", "kg", "Current missile mass after motor propellant burn-down.", "Missile", "history", "derived", valid_range=_r(0.0, None), derived=True),
    "missile_accel_mps2": _m("missile_accel_mps2", "Missile Acceleration", "m/s^2", "Total missile acceleration magnitude from thrust and guidance control acceleration.", "Missile", "history", "derived", valid_range=_r(0.0, None), derived=True),
    "seeker_valid": _m("seeker_valid", "Seeker Valid", "", "Boolean flag indicating the missile seeker currently has a valid target measurement.", "Seeker", "history", "gnc", valid_range=_r(0.0, 1.0), derived=True),
    "missile_seeker_status": _m("missile_seeker_status", "Seeker Status", "", "Discrete seeker gate status, such as valid, out-of-range, or outside field-of-view.", "Seeker", "history", "gnc", derived=True),
    "missile_seeker_range_m": _m("missile_seeker_range_m", "Seeker Range", "m", "Line-of-sight range measured by the missile seeker.", "Seeker", "history", "gnc", valid_range=_r(0.0, None), derived=True),
    "missile_seeker_aspect_deg": _m("missile_seeker_aspect_deg", "Seeker Aspect", "deg", "Angle between missile boresight and line of sight to the target.", "Seeker", "history", "gnc", valid_range=_r(0.0, 180.0), derived=True),
    "missile_guidance_valid": _m("missile_guidance_valid", "Missile Guidance Valid", "", "Boolean flag indicating the missile guidance law issued a valid acceleration command.", "Missile GNC", "history", "gnc", valid_range=_r(0.0, 1.0), derived=True),
    "missile_guidance_status": _m("missile_guidance_status", "Missile Guidance Status", "", "Discrete guidance-law status for the active missile.", "Missile GNC", "history", "gnc", derived=True),
    "missile_commanded_accel_mps2": _m("missile_commanded_accel_mps2", "Commanded Missile Accel", "m/s^2", "Guidance-law acceleration command before actuator rate and saturation limits.", "Missile GNC", "history", "command", valid_range=_r(0.0, None), derived=True),
    "missile_lateral_accel_mps2": _m("missile_lateral_accel_mps2", "Missile Lateral Accel", "m/s^2", "Actual lateral control acceleration after missile actuator dynamics.", "Missile Actuators", "history", "actuator_state", valid_range=_r(0.0, None), derived=True),
    "missile_control_rate_limited": _m("missile_control_rate_limited", "Missile Rate Limited", "", "Boolean flag indicating the missile control actuator hit its acceleration-rate limit.", "Missile Actuators", "history", "actuator_state", valid_range=_r(0.0, 1.0), derived=True),
    "missile_control_saturated": _m("missile_control_saturated", "Missile Control Saturated", "", "Boolean flag indicating the missile control actuator hit its acceleration magnitude limit.", "Missile Actuators", "history", "actuator_state", valid_range=_r(0.0, 1.0), derived=True),
    "missile_motor_thrust_n": _m("missile_motor_thrust_n", "Missile Motor Thrust", "N", "Current missile motor thrust after spool and burn-time logic.", "Missile Propulsion", "history", "propulsion", valid_range=_r(0.0, None), derived=True),
    "missile_motor_mass_flow_kgps": _m("missile_motor_mass_flow_kgps", "Missile Motor Mass Flow", "kg/s", "Missile motor propellant mass flow rate.", "Missile Propulsion", "history", "propulsion", valid_range=_r(0.0, None), derived=True),
    "missile_motor_spool_fraction": _m("missile_motor_spool_fraction", "Missile Motor Spool", "", "Motor thrust spool fraction from zero to full commanded thrust.", "Missile Propulsion", "history", "propulsion", valid_range=_r(0.0, 1.0), derived=True),
    "missile_motor_phase": _m("missile_motor_phase", "Missile Motor Phase", "", "Discrete motor phase, such as spooling, burning, or burnout.", "Missile Propulsion", "history", "propulsion", derived=True),
    "missile_closing_speed_mps": _m("missile_closing_speed_mps", "Missile Closing Speed", "m/s", "Positive missile seeker closing speed against the assigned target.", "Missile", "history", "derived", derived=True),
    "missile_fuze_armed": _m("missile_fuze_armed", "Missile Fuze Armed", "", "Boolean flag indicating the missile fuze arming delay has elapsed.", "Missile Fuze", "history", "derived", valid_range=_r(0.0, 1.0), derived=True),
    "missile_fuzed": _m("missile_fuzed", "Missile Fuzed", "", "Boolean flag indicating proximity fuze or terminal fuze logic has triggered.", "Missile Fuze", "history", "derived", valid_range=_r(0.0, 1.0), derived=True),
    "missile_fuze_status": _m("missile_fuze_status", "Missile Fuze Status", "", "Discrete fuze status, including armed, safe, proximity, and self-destruct states.", "Missile Fuze", "history", "derived", derived=True),
    "missile_fuze_closest_range_m": _m("missile_fuze_closest_range_m", "Missile Fuze Closest Range", "m", "Closest target range tracked by the fuze logic.", "Missile Fuze", "history", "derived", valid_range=_r(0.0, None), derived=True),
