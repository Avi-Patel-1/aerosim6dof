...
| Methodology | How do I review the engineering rationale? | architecture, system-flow, model-assumption, validation, and extension guides | code-path references, artifact evidence chains, review prompts |
...
9. Use **Reports** to collect HTML, SVG, CSV, JSON, job history, and mission
   packet exports.
10. Use **Methodology** to review architecture, system flow, modeling
   assumptions, analysis workflows, validation strategy, and extension patterns.
