...
_TELEMETRY_HIGHLIGHT_CHANNELS = (
    ...
    ("history", "missile_speed_mps", "Missile speed", "m/s"),
    ("history", "missile_seeker_range_m", "Missile seeker range", "m"),
    ("history", "missile_closing_speed_mps", "Missile closing speed", "m/s"),
    ("history", "missile_motor_thrust_n", "Missile motor thrust", "N"),
    ("history", "missile_motor_spool_fraction", "Missile motor spool", ""),
    ("history", "missile_lateral_accel_mps2", "Missile lateral accel", "m/s^2"),
    ("history", "missile_control_saturated", "Missile control saturated", ""),
    ("history", "missile_fuze_armed", "Missile fuze armed", ""),
    ("history", "missile_fuzed", "Missile fuzed", ""),
