...
def build_rows(
    ...
    truth = {
        ...
        "missile_mode": _float(interceptor.get("missile_mode"), 0.0),
        "missile_speed_mps": _float(interceptor.get("missile_speed_mps")),
        "missile_mass_kg": _float(interceptor.get("missile_mass_kg")),
        "missile_accel_mps2": _float(interceptor.get("missile_accel_mps2"), 0.0),
        "seeker_valid": _float(interceptor.get("seeker_valid"), 0.0),
        "missile_seeker_status": str(interceptor.get("missile_seeker_status", "")),
        "missile_seeker_range_m": _float(interceptor.get("missile_seeker_range_m")),
        "missile_seeker_aspect_deg": _float(interceptor.get("missile_seeker_aspect_deg")),
        "missile_guidance_valid": _float(interceptor.get("missile_guidance_valid"), 0.0),
        "missile_guidance_status": str(interceptor.get("missile_guidance_status", "")),
        "missile_motor_thrust_n": _float(interceptor.get("missile_motor_thrust_n"), 0.0),
        "missile_motor_mass_flow_kgps": _float(interceptor.get("missile_motor_mass_flow_kgps"), 0.0),
        "missile_motor_spool_fraction": _float(interceptor.get("missile_motor_spool_fraction"), 0.0),
        "missile_motor_phase": str(interceptor.get("missile_motor_phase", "")),
        "missile_commanded_accel_mps2": _float(interceptor.get("missile_commanded_accel_mps2"), 0.0),
        "missile_lateral_accel_mps2": _float(interceptor.get("missile_lateral_accel_mps2"), 0.0),
        "missile_control_rate_limited": _float(interceptor.get("missile_control_rate_limited"), 0.0),
        "missile_control_saturated": _float(interceptor.get("missile_control_saturated"), 0.0),
        "missile_closing_speed_mps": _float(interceptor.get("missile_closing_speed_mps")),
        "missile_fuze_armed": _float(interceptor.get("missile_fuze_armed"), 0.0),
        "missile_fuzed": _float(interceptor.get("missile_fuzed"), 0.0),
        "missile_fuze_status": str(interceptor.get("missile_fuze_status", "")),
        "missile_fuze_closest_range_m": _float(interceptor.get("missile_fuze_closest_range_m")),
